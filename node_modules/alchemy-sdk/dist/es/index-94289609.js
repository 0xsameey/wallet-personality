import { formatUnits, isHexString, hexStripZeros, hexValue as hexValue$1 } from './api/utils';
    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield import('./alchemy-provider-0b2e9f09.js');
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield import('./alchemy-websocket-provider-2f8b1006.js');
        ...
        return __awaiter$1(this, void 0, void 0, function* () {
            ...
            if (isHexString(blockIdentifier, 32)) {
                ...
                const block = typeof blockIdentifier === 'number'
                    ? hexStripZeros(hexValue$1(blockIdentifier))
                    : blockIdentifier;
...
//# sourceMappingURL=index-94289609.js.map
